...
<body>
<jsp:useBean id="obj" class="com.usebean.Student" scope="session"></jsp:useBean>
...
<!-- Set property -->
<jsp:setProperty property="id" name="obj" value="79035"/>
<jsp:setProperty property="name" name="obj" value="Ravikant"/>
